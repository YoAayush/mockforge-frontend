                        ...
                        {[
                            {
                                ...
                                description: 'Generate mock APIs instantly without any backend setup or deployment'
                            },
                            {
                                icon: Layers,
                                title: 'Flexible Schemas',
                                description: 'Define complex data models with custom fields, types, and faker generators'
                            },
                            {
                                icon: Code,
                                title: 'REST API Ready',
                                description: 'Auto-generated REST endpoints for all CRUD operations on your schemas'
                            },
                            {
                                icon: BookOpen,
                                title: 'Interactive Playground',
                                description: 'Test your APIs directly in the browser with the built-in API playground'
                            },
                            {
                                icon: Copy,
                                title: 'Easy Integration',
                                description: 'Simple HTTP calls - use with any language or framework'
                            },
                            {
                                icon: Check,
                                title: 'Realistic Data',
                                description: 'Auto-generate realistic test data using Faker generators'
                            }
                        ].map((feature) => {
                        ...
                        {[
                            {
                                ...
                                description: 'Create a data model by defining fields and their types. Add custom faker generators for realistic test data.'
                            },
                            {
                                step: '2',
                                title: 'Generate Endpoints',
                                description: 'MockForge automatically generates REST API endpoints for all CRUD operations based on your schema.'
                            },
                            {
                                step: '3',
                                title: 'Start Building',
                                description: 'Use the auto-generated API endpoints in your application. No backend needed!'
                            }
                        ].map((item) => (
                        ...
                        {[
                            {
                                ...
                                description: 'Create separate schemas for each resource type (users, products, orders, etc.) to keep your API organized.'
                            },
                            {
                                title: 'Use Realistic Data',
                                description: 'Leverage faker generators to create realistic test data that matches your production data format.'
                            },
                            {
                                title: 'Version Your Schemas',
                                description: 'Keep track of schema versions to manage changes and maintain backwards compatibility.'
                            },
                            {
                                title: 'Set Record Limits',
                                description: 'Configure appropriate record limits to prevent accidental generation of massive datasets.'
                            },
                            {
                                title: 'Test Thoroughly',
                                description: 'Use the API Playground to test all endpoints before using them in your application.'
                            },
                            {
