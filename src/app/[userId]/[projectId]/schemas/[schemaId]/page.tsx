    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="border-b border-default px-8 py-6 flex items-center gap-4 bg-secondary">
                <Link href={`/${userId}/${projectId}/dashboard`} className="flex items-center gap-2 text-accent hover:text-primary transition-colors">
                ...
                {activeTab === 'form' ? (
                    <div className="space-y-6">
                                    ...
                                    <div key={field.id} className="flex gap-4 items-end p-4 bg-tertiary rounded border border-border">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => handleFieldChange(field.id, 'faker', e.target.value)}
                                                className="w-full bg-primary border border-default rounded px-4 py-2 text-primary text-sm focus:outline-none focus:ring-2 focus:ring-[rgb(var(--accent))]"
                                            >
                                                <option>None</option>
                                                <option>Name</option>
                        ...
                        <div className="flex justify-end gap-3">
                            ...
                            <button className="px-6 py-2 rounded bg-[rgb(var(--accent))] text-white hover:opacity-90 transition-colors font-semibold">
                                Update Schema
                            </button>
                        </div>
                    </div>
